...
const GroupDiscussions = ({
      ...
      let referralListByStatus = data.filter((referrals) => {
        return (
          ...
          (referrals.status === "Rejected" &&
            referrals.rejectedIn === "Group Discussion")
        );
      });
      // console.log("referrals", data.rejectedIn);
      // console.log("currentRound", data.currentRound);
      // console.log("rejected in", data.re)
      // console.log("current round", data.currentRound)
      // const newObj = Object.assign({}, ...data);
      // let referralListByStatus;
      // console.log("newObj", newObj);
      // if (
      //   newObj.status === "Rejected" &&
      //   newObj.rejectedIn === "Group Discussion"
      // ) {
      //   referralListByStatus = data.filter((referrals) => {
      //     // console.log("referrals", referrals)
      //     return referrals.status === "Rejected";
      //   });
      // } else {
      //   referralListByStatus = data.filter((referrals) => {
      //     // console.log("referrals", referrals)
      //     // console.log("referrals", referrals.status)
      //     // console.log("referrals", statusValue)

      //     return referrals.status === statusValue;
      //   });
      // }
      // console.log("only Gd", referralListByStatus)
  ...
  const getAllSchedulesMailList = async () => {
    try {
      const response = await fetch(
      ...
      cell: (row) => {
        ...
        if (row.resume_file?.data) {
          ...
          return (
            ...
            >
              <img src={isTheme? PdfThemeDarkIcon:PdfThemeLightIcon} alt="" className="pdfImage" />
