...
const FinalHR = ({
  ...
  const [dataTableReferesh, setDataTableRefresh] = useState();
      ...
      let referralListByStatus = data.filter((referrals) => {
        return (
          ...
          (referrals.status === "Rejected" &&
            referrals.rejectedIn === "HR Round")
        );
      });
      // const referralListByStatus = data.filter((referrals) => {
      ...
      cell: (row) =>
        loading ? (
          ...
          >
            ...
            >
              <img
                src={row.mailStatus === "Sent" ? MailSentIcon : MailNotSentIcon}
                className="mailIcons"
              />
            </div>
          ...
          <div style={{ textAlign: "center" }}>
            {isPending ? (
              ...
              <div className="highlight-rejected">
                {" "}
                <img src={RejectedIcon} alt="" width={16} height={16} />
                <span> {displayText}</span>
              </div>
            )}
          </div>
